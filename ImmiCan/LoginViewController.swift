...
class LoginViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        NSLayoutConstraint.activate([
            googleloginButton.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 60),
            googleloginButton.centerYAnchor.constraint(equalTo: view.bottomAnchor, constant: -180),
            googleloginButton.widthAnchor.constraint(equalToConstant: 140),
            googleloginButton.heightAnchor.constraint(equalToConstant: 50)
            // Adjust the constraint based on your requirements
        ])
