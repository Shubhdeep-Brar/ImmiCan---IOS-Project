...
//  ImmiCan
//
//  Created by Ramneek Kaur on 2023-04-25.
//

import Foundation
import UIKit
import PhotosUI
class SellHouse : UIViewController, UINavigationControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        textFieldStack.addArrangedSubview(postalCodeTextField)
        textFieldStack.addArrangedSubview(bedroomsTextField)
        textFieldStack.addArrangedSubview(bathroomsTextField)
        textFieldStack.addArrangedSubview(priceTextField)
        textFieldStack.addArrangedSubview(areaTextField)
...
//            titleTextField.bottomAnchor.constraint(equalTo: textFieldStack.topAnchor, constant: 60)
        ...
        NSLayoutConstraint.activate([
            addressTextField.topAnchor.constraint(equalTo: textFieldStack.topAnchor, constant: 10),
            addressTextField.leadingAnchor.constraint(equalTo: textFieldStack.leadingAnchor, constant: 5),
            addressTextField.trailingAnchor.constraint(equalTo: textFieldStack.trailingAnchor, constant: -5),
//            addressTextField.bottomAnchor.constraint(equalTo: titleTextField.bottomAnchor, constant: 70)
        ])
        NSLayoutConstraint.activate([
//            postalCodeTextField.topAnchor.constraint(equalTo: textFieldStack.topAnchor, constant: 10),
            postalCodeTextField.leadingAnchor.constraint(equalTo: textFieldStack.leadingAnchor, constant: 5),
            postalCodeTextField.trailingAnchor.constraint(equalTo: textFieldStack.trailingAnchor, constant: -5),
//            postalCodeTextField.bottomAnchor.constraint(equalTo: addressTextField.bottomAnchor, constant: 70)
        ])
        NSLayoutConstraint.activate([
//            bedroomsTextField.topAnchor.constraint(equalTo: textFieldStack.topAnchor, constant: 10),
            bedroomsTextField.leadingAnchor.constraint(equalTo: textFieldStack.leadingAnchor, constant: 5),
            bedroomsTextField.trailingAnchor.constraint(equalTo: textFieldStack.trailingAnchor, constant: -5),
//            bedroomsTextField.bottomAnchor.constraint(equalTo: textFieldStack.topAnchor, constant: 60)
        ])
        NSLayoutConstraint.activate([
//            bathroomsTextField.topAnchor.constraint(equalTo: textFieldStack.topAnchor, constant: 10),
            bathroomsTextField.leadingAnchor.constraint(equalTo: textFieldStack.leadingAnchor, constant: 5),
            bathroomsTextField.trailingAnchor.constraint(equalTo: textFieldStack.trailingAnchor, constant: -5),
//            bathroomsTextField.bottomAnchor.constraint(equalTo: textFieldStack.topAnchor, constant: 60)
        ])
...
//            areaTextField.topAnchor.constraint(equalTo: titleTextField.bottomAnchor, constant: 20),
            areaTextField.leadingAnchor.constraint(equalTo: textFieldStack.leadingAnchor, constant: 5),
            areaTextField.trailingAnchor.constraint(equalTo: textFieldStack.trailingAnchor, constant: -5),
//            areaTextField.bottomAnchor.constraint(equalTo: titleTextField.bottomAnchor, constant: 70)
        ])
...
//            postButton.bottomAnchor.constraint(equalTo: descriptionTextField.topAnchor, constant: -220)
        ])

        collectionView.register(AddImagesHousing.self, forCellWithReuseIdentifier: AddImagesHousing.identifier)
...
extension SellHouse: UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell  = collectionView.dequeueReusableCell(withReuseIdentifier: AddImagesHousing.identifier, for: indexPath) as! AddImagesHousing
...
extension SellHouse: UICollectionViewDataSource {
...
extension SellHouse: UICollectionViewDelegateFlowLayout {
...
extension SellHouse : PHPickerViewControllerDelegate {
...
extension SellHouse: UIImagePickerControllerDelegate {
